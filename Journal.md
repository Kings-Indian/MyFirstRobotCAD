...
I first screwed on the motors. I then screwed on the tank drive modules. I then decided to wire the stepdown, but then realized that it was not nessesary since the L298N H bridges have 5v. I wired everything and popped the modules into place
**Time Spent: 4h**
**Time Spent in Total: 18.30 hr**
